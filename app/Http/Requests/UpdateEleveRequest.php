...
class UpdateEleveRequest extends FormRequest
{
    ...
    /** Retourne les règles de validation du formulaire d'édition élève. */
    public function rules(): array
    {
        return [
            ...
            'parent.prenoms' => ['nullable', 'string', 'max:150'],
            'parent.lien' => ['nullable', Rule::in(array_values(ParentTuteur::LIENS))],
            'parent.profession' => ['nullable', 'string', 'max:100'],
            'parent.telephone_1' => ['nullable', 'string', 'regex:/^0[0-9]{9}$/'],
