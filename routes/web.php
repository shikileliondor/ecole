...
Route::middleware(['auth'])->prefix('finances')->name('finances.')->group(function (): void {
    ...
    Route::delete('/depenses/{depense}', [FinanceController::class, 'destroyDepense'])->name('depenses.destroy');
...
Route::middleware(['auth','throttle:sms'])->prefix('api')->name('api.')->group(function (): void {
